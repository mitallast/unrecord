...
impl<'a> Waveform<'a> {
    ...
    pub fn show(self, ui: &mut egui::Ui) -> egui::InnerResponse<WaveformResponse> {
        ...
        .fold(None, |a: Option<Range<f32>>, b| {
            Some(match a {
                None => b,
        ...
        // let rect = rect.shrink(ui.style().visuals.widgets.noninteractive.bg_stroke.width);
        ...
        // let rect = rect.shrink(self.corner_radius.average() / 2.0);
